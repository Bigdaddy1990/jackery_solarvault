...
class TestThirdPartyMqttCodec:
    ...
    def test_stable_token_user_provided_valid(self) -> None:
    ...
    def test_stable_token_user_matches_generated(self) -> None:
    ...
    def test_stable_token_no_user_no_generated(self) -> None:
    ...
    def test_stable_token_no_user_has_generated(self) -> None:
    ...
    def test_config_from_options_custom_values(self) -> None:
    ...
    def test_config_plaintext_without_device_data(self) -> None:
    ...
    def test_config_plaintext_with_device_data(self) -> None:
    ...
    def test_decode_config_body_missing_bluetooth_key(self) -> None:
