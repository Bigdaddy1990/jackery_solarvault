...
class TestJackerySelect:
    ...
    def _create_select(self, coordinator, key="work_mode_select"):  # ruff: ignore[no-self-use]  # ruff: ignore[missing-type-function-argument, missing-return-type-private-function]
