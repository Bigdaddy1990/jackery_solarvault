...
class TestStormMinutesHelpers:
    ...
    def test_storm_minutes_value_from_properties(self) -> None:
    ...
    def test_storm_minutes_value_from_weather_plan(self) -> None:
    ...
    def test_storm_minutes_value_below_min_valid(self) -> None:
    ...
    def test_storm_minutes_fallback_with_wps(self) -> None:
    ...
    def test_storm_minutes_label(self) -> None:
...
class TestPriceSourceHelpers:
    ...
    def test_price_source_label(self) -> None:
    ...
    def test_price_source_regions(self) -> None:
    ...
    def test_price_source_matches_current(self) -> None:
    ...
    def test_price_sources_from_payload(self) -> None:
    ...
    def test_price_mode_dynamic_available(self) -> None:
...
class TestWorkModeCurrent:
    ...
    def test_work_mode_current_from_properties(self) -> None:
    ...
    def test_work_mode_current_unknown_logs_warning(self) -> None:
...
class TestTempUnitCurrent:
    ...
    def test_temp_unit_current(self) -> None:
...
class TestIslandAutoOffCurrent:
    ...
    def test_island_auto_off_current_from_properties(self) -> None:
    ...
    def test_island_auto_off_current_from_task_plan(self) -> None:
...
class TestStormMinutesCurrent:
    ...
    def test_storm_minutes_current_value(self) -> None:
    ...
    def test_storm_minutes_options(self) -> None:
    ...
    def test_storm_minutes_current(self) -> None:
...
class TestPriceModeCurrent:
    ...
    def test_price_mode_current_dynamic(self) -> None:
...
class TestPriceProviderHelpers:
    ...
    def test_price_provider_options(self) -> None:
    ...
    def test_price_provider_current(self) -> None:
...
class TestCtPhaseCurrent:
    ...
    def test_ct_phase_current(self) -> None:
...
class TestPortableSelectCurrent:
    ...
    def test_portable_ups_model_current(self) -> None:
    ...
    def test_portable_ups_model_current_standard(self) -> None:
    ...
    def test_portable_battery_mode_current(self) -> None:
    ...
    def test_portable_charge_mode_current(self) -> None:
    ...
    def test_portable_power_mode_current(self) -> None:
    ...
    def test_portable_screen_current(self) -> None:
    ...
    def test_portable_ac_output_mode_current(self) -> None:
    ...
    def test_portable_output_priority_current(self) -> None:
    ...
    def test_portable_ac1_priority_current(self) -> None:
    ...
    def test_portable_ac2_priority_current(self) -> None:
    ...
    def test_portable_dc_priority_current(self) -> None:
...
class TestJackerySelect:
    ...
    def _create_select(self, coordinator, key="work_mode_select"):
