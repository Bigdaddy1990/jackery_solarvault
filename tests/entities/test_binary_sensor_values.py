...
class TestJackeryBinarySensorEntityFlags:
    ...
    def test_diagnostic_sensor_is_disabled_by_default(self) -> None:  # noqa: PLR6301
        """All DIAGNOSTIC binary sensors must be disabled in the entity registry by.
    ...
    def test_entity_description_is_set(self) -> None:  # noqa: PLR6301
        """The entity_description attribute must be the same object passed to.
...
class TestGetterIsolation:
    ...
    def test_online_getter_reads_only_device_meta(self) -> None:  # noqa: PLR6301
        """'online' getter must use the second argument (device_meta), not.
    ...
    def test_eps_active_getter_reads_only_properties(self) -> None:  # noqa: PLR6301
        """'eps_active' getter must use the first argument (properties), not.
