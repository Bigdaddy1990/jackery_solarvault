...
def test_init_imports_jackery_local_mqtt_client() -> None:
    ...
    """
    try:
        from custom_components.jackery_solarvault.client.local_mqtt import (  # ruff: ignore[import-outside-top-level]  # isort: skip
...
def test_client_init_imports_jackery_auth_error() -> None:
    ...
    from custom_components.jackery_solarvault.client import JackeryAuthError  # ruff: ignore[import-outside-top-level]  # isort: skip
...
def test_client_init_imports_jackery_error() -> None:
    ...
    from custom_components.jackery_solarvault.client import JackeryError  # ruff: ignore[import-outside-top-level]  # isort: skip
...
def _legacy_suffix_matches(uid: str, key_suffix: str) -> bool:
    ...
    from custom_components.jackery_solarvault import (  # ruff: ignore[import-outside-top-level]  # isort: skip
        _legacy_suffix_matches as _fn,  # ruff: ignore[import-private-name]  # isort: skip
    )
...
def test_legacy_suffix_matches_head_cannot_have_trailing_underscore() -> None:
    """A digits head with a trailing underscore before the suffix is fine if suffix starts with underscore."""  # ruff: ignore[line-too-long]  # isort: skip
...
def test_local_mqtt_result_warning_condition_fires_for_runtime_error() -> None:
    """The isinstance(local_mqtt_result, BaseException) condition must be True for RuntimeError."""  # ruff: ignore[line-too-long]  # isort: skip
