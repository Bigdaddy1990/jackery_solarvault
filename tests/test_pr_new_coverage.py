...
def test_init_imports_jackery_local_mqtt_client() -> None:
    ...
    """
    from custom_components.jackery_solarvault.client.mqtt.local_mqtt import (  # noqa: PLC0415
...
def test_client_init_imports_jackery_auth_error() -> None:
    ...
    from custom_components.jackery_solarvault.client import JackeryAuthError  # noqa: I001, PLC0415
...
def test_client_init_imports_jackery_error() -> None:
    ...
    from custom_components.jackery_solarvault.client import JackeryError  # noqa: I001, PLC0415
...
def _legacy_suffix_matches(uid: str, key_suffix: str) -> bool:
    ...
    from custom_components.jackery_solarvault import _legacy_suffix_matches as _fn  # noqa: I001, PLC0415, PLC2701
...
def test_legacy_suffix_matches_head_cannot_have_trailing_underscore() -> None:
    """A digits head with a trailing underscore before the suffix is fine if suffix starts with underscore."""  # noqa: E501
...
def test_local_mqtt_result_warning_condition_fires_for_runtime_error() -> None:
    """The isinstance(local_mqtt_result, BaseException) condition must be True for RuntimeError."""  # noqa: E501
