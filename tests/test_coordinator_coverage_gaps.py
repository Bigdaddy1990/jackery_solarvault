...
class TestBackfillPeriodIsClosed:
    ...
    def test_day_type_closed_when_yesterday(self) -> None:
    ...
    def test_week_type_open_when_current_week(self) -> None:
    ...
    def test_month_type_december_boundary(self) -> None:
    ...
    def test_month_type_january_open(self) -> None:
    ...
    def test_month_type_regular_month_closed(self) -> None:
    ...
    def test_month_type_current_month_open(self) -> None:
    ...
    def test_year_type_closed_when_last_year(self) -> None:
    ...
    def test_year_type_open_when_current_year(self) -> None:
    ...
    def test_unknown_date_type_returns_false(self) -> None:
...
class TestMqttConnectFailureSignature:
    ...
    def test_mqtt_not_connected_yet_prefix(self) -> None:
    ...
    def test_mqtt_not_connected_yet_long_message_truncated(self) -> None:
    ...
    def test_generic_message_truncated_to_160(self) -> None:
...
class TestMqttConnectionManagerCoverageGaps:
    ...
    def test_retry_delay_calculates_max_of_three_delays(self) -> None:
    ...
    def test_retry_delay_zero_when_all_expired(self) -> None:
    ...
    def test_record_connect_success_early_return_when_mqtt_none(self) -> None:
    ...
    def test_handle_connect_error_early_return_when_mqtt_none(self) -> None:
        ...
        assert mgr.backoff_until_monotonic == 0.0

    def test_handle_connect_error_prefers_last_error_from_diagnostics(self) -> None:
    ...
    def test_handle_connect_error_fallback_to_passed_error(self) -> None:
    ...
    def test_defer_background_auth_failure_with_none_mqtt(self) -> None:
