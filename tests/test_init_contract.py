...
The integration imports cleanly; these tests import it directly and fail
loudly if a syntax/dependency regression breaks the import.
"""
...
def _make_coordinator_stub() -> MagicMock:
    """Return a coordinator stub for local MQTT message dispatch."""
...
async def test_async_start_local_mqtt_does_nothing_when_disabled() -> None:
    ...
    await _async_start_local_mqtt(hass, entry, _make_coordinator_stub())
