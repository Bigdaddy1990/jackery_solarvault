...
@pytest.mark.asyncio()
async def test_endpoint_backoff_active_returns_false_when_no_state(coordinator) -> None:  # noqa: ANN001, RUF029, RUF105
...
@pytest.mark.asyncio()
async def test_endpoint_backoff_active_returns_true_when_active(coordinator) -> None:  # noqa: ANN001, RUF029, RUF105
...
@pytest.mark.asyncio()
async def test_endpoint_backoff_is_energy_key(coordinator) -> None:  # noqa: ANN001, RUF029, RUF105
...
@pytest.mark.asyncio()
async def test_endpoint_backoff_delays_for_key_energy(coordinator) -> None:  # noqa: ANN001, RUF029, RUF105
...
@pytest.mark.asyncio()
async def test_endpoint_backoff_delays_for_key_ratelimit(coordinator) -> None:  # noqa: ANN001, RUF029, RUF105
...
@pytest.mark.asyncio()
async def test_endpoint_backoff_delays_for_key_default(coordinator) -> None:  # noqa: ANN001, RUF029, RUF105
...
@pytest.mark.asyncio()
async def test_endpoint_backoff_note_failure_records_backoff(coordinator) -> None:  # noqa: ANN001, RUF029, RUF105
    ...
    assert state["code"] == 10422  # noqa: PLR2004, RUF105
...
async def test_endpoint_backoff_note_failure_resets_level_on_different_code(  # noqa: RUF029, RUF105
    ...
    state = coordinator._endpoint_backoff["test_key"]  # noqa: RUF105, SLF001
    assert state["level"] == 0
    assert state["code"] == 10432  # noqa: PLR2004, RUF105


@pytest.mark.asyncio()
async def test_endpoint_backoff_note_failure_ignores_unknown_codes(coordinator) -> None:  # noqa: ANN001, RUF029, RUF105
...
@pytest.mark.asyncio()
async def test_endpoint_backoff_note_timeout_opens_window(coordinator) -> None:  # noqa: ANN001, RUF029, RUF105
...
@pytest.mark.asyncio()
async def test_endpoint_backoff_note_timeout_escalates(coordinator) -> None:  # noqa: ANN001, RUF029, RUF105
...
@pytest.mark.asyncio()
async def test_endpoint_backoff_note_success_clears_state(coordinator) -> None:  # noqa: ANN001, RUF029, RUF105
...
@pytest.mark.asyncio()
async def test_endpoint_backoff_note_success_idempotent(coordinator) -> None:  # noqa: ANN001, RUF029, RUF105
...
@pytest.mark.asyncio()
async def test_endpoint_backoff_active_count(coordinator) -> None:  # noqa: ANN001, RUF029, RUF105
    ...
    assert coordinator._endpoint_backoff_active_count(now) == 2  # noqa: PLR2004, RUF105, SLF001


@pytest.mark.asyncio()
async def test_is_backoffable_timeout_detects_shelly_timeout(coordinator) -> None:  # noqa: ANN001, RUF029, RUF105
...
@pytest.mark.asyncio()
async def test_is_backoffable_timeout_ignores_non_shelly_timeout(coordinator) -> None:  # noqa: ANN001, RUF029, RUF105
...
@pytest.mark.asyncio()
async def test_is_backoffable_timeout_ignores_non_timeout_cause(coordinator) -> None:  # noqa: ANN001, RUF029, RUF105
...
@pytest.mark.asyncio()
async def test_is_backoffable_timeout_ignores_none_cause(coordinator) -> None:  # noqa: ANN001, RUF029, RUF105
...
@pytest.mark.asyncio()
async def test_is_backoffable_timeout_with_none_backoff_key(coordinator) -> None:  # noqa: ANN001, RUF029, RUF105
