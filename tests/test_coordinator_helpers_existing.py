...
class TestCoordinatorHelpersExisting:
    ...
    def test_normalize_backfill_status(self) -> None:
        """Test _normalize_backfill_status."""
        from custom_components.jackery_solarvault.coordinator import BackfillStatus
    ...
    def test_dict_list_identity_values(self) -> None:
    ...
    def test_shelly_cloud_api_device_id(self) -> None:
    ...
    def test_shelly_cloud_api_device_id_returns_none_for_non_shelly(self) -> None:
