...
class TestDictListIdentityValues:
    ...
    def test_returns_serial_keys(self) -> None:  # noqa: PLR6301
    ...
    def test_returns_id_keys(self) -> None:  # noqa: PLR6301
    ...
    def test_skips_blank_values(self) -> None:  # noqa: PLR6301
    ...
    def test_returns_empty_for_no_identifiers(self) -> None:  # noqa: PLR6301
...
class TestIsBlankValue:
    ...
    def test_returns_true_for_none(self) -> None:  # noqa: D102, PLR6301
        assert _is_blank_value(None) is True

    def test_returns_true_for_empty_string(self) -> None:  # noqa: D102, PLR6301
        assert _is_blank_value("") is True

    def test_returns_true_for_whitespace_string(self) -> None:  # noqa: D102, PLR6301
        assert _is_blank_value("   ") is True

    def test_returns_true_for_empty_list(self) -> None:  # noqa: D102, PLR6301
        assert _is_blank_value([]) is True

    def test_returns_true_for_empty_dict(self) -> None:  # noqa: D102, PLR6301
        assert _is_blank_value({}) is True

    def test_returns_false_for_non_blank_string(self) -> None:  # noqa: D102, PLR6301
        assert _is_blank_value("value") is False

    def test_returns_false_for_non_blank_list(self) -> None:  # noqa: D102, PLR6301
        assert _is_blank_value([1, 2]) is False

    def test_returns_false_for_non_blank_dict(self) -> None:  # noqa: D102, PLR6301
        assert _is_blank_value({"key": "value"}) is False

    def test_returns_false_for_zero(self) -> None:  # noqa: D102, PLR6301
        assert _is_blank_value(0) is False

    def test_returns_false_for_false_bool(self) -> None:  # noqa: D102, PLR6301
...
class TestCleanDictListUpdate:
    ...
    def test_removes_blank_values(self) -> None:  # noqa: PLR6301
    ...
    def test_preserves_non_blank_values(self) -> None:  # noqa: PLR6301
        """Preserves keys with non-blank values."""
        update = {
            "key1": "value",
            "key2": 0,
            "key3": False,
            "key3": {"nested": "value"},  # noqa: F601
        }
        result = _clean_dict_list_update(update)
    ...
    def test_returns_empty_for_all_blank(self) -> None:  # noqa: PLR6301
...
class TestMergeDictValues:
    ...
    def test_merges_updates_into_base(self) -> None:  # noqa: PLR6301
    ...
    def test_overwrites_base_with_none(self) -> None:  # noqa: PLR6301
    ...
    def test_handles_nested_dicts(self) -> None:  # noqa: PLR6301
...
class TestMergePresentDictValuesAdditional:
    ...
    def test_handles_list_updates(self) -> None:  # noqa: PLR6301
    ...
    def test_handles_list_with_new_item(self) -> None:  # noqa: PLR6301
    ...
    def test_update_overwrites_when_base_blank(self) -> None:  # noqa: PLR6301
