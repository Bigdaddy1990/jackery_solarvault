...
class TestClientModule:
    ...
    def test_jackery_api_has_public_methods(self) -> None:
    ...
    def test_jackery_ble_listener_has_public_methods(self) -> None:
    ...
    def test_jackery_local_mqtt_client_has_public_methods(self) -> None:
    ...
    def test_jackery_mqtt_push_client_has_public_methods(self) -> None:
...
class TestLazyImports:
    ...
    def test_jackery_mqtt_push_client_lazy_import(self) -> None:
