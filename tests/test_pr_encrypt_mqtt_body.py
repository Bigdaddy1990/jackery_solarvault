...
def test_encrypt_mqtt_body_round_trip() -> None:
    ...
    from cryptography.hazmat.primitives.ciphers import Cipher, algorithms, modes  # noqa: I001, PLC0415
    from cryptography.hazmat.primitives.padding import PKCS7  # noqa: PLC0415
