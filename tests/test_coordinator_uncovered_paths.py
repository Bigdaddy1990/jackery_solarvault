...
class TestNormalizeBackfillStatus:
    ...
    def test_unknown_closed_maps_to_pending(self) -> None:  # noqa: PLR6301
    ...
    def test_invalid_type_returns_pending(self) -> None:  # noqa: PLR6301
...
class TestChangedDictValues:
    ...
    def test_returns_empty_for_no_changes(self) -> None:  # noqa: D102, PLR6301
        before = {"a": 1}
        after = {"a": 1}
        result = changed_dict_values(before, after)
        assert result == {}
