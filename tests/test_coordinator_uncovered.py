...
class TestJackerySolarVaultCoordinator:  # ruff: ignore[too-many-public-methods]
    ...
    @staticmethod
    def _closed_background_task(*args, **_kwargs) -> MagicMock:  # ruff: ignore[missing-type-args, missing-type-kwargs]
    ...
    def _create_coordinator(self, hass=None) -> JackerySolarVaultCoordinator:  # ruff: ignore[missing-type-function-argument]
