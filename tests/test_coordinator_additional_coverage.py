...
class TestBatteryPackFromSource:
    ...
    def test_extracts_from_battery_packs_key(self) -> None:  # noqa: PLR6301, RUF105
    ...
    def test_extracts_from_battery_pack_key(self) -> None:  # noqa: PLR6301, RUF105
    ...
    def test_extracts_from_battery_pack_list_key(self) -> None:  # noqa: PLR6301, RUF105
    ...
    def test_returns_none_when_no_known_keys(self) -> None:  # noqa: PLR6301, RUF105
    ...
    def test_extracts_from_sub_device_key(self) -> None:  # noqa: PLR6301, RUF105
        """Extracts from FIELD_SUB_DEVICE key."""
        from custom_components.jackery_solarvault.const import FIELD_SUB_DEVICE  # noqa: I001, PLC0415, RUF105
    ...
    def test_extracts_from_list_source(self) -> None:  # noqa: PLR6301, RUF105
...
class TestMergePresentDictValuesEdgeCases:
    ...
    def test_preserves_base_when_update_is_empty_list(self) -> None:  # noqa: PLR6301, RUF105
    ...
    def test_preserves_base_when_update_is_empty_dict(self) -> None:  # noqa: PLR6301, RUF105
    ...
    def test_blank_update_with_non_blank_base_preserves(self) -> None:  # noqa: PLR6301, RUF105
    ...
    def test_update_overwrites_when_base_is_blank(self) -> None:  # noqa: PLR6301, RUF105
...
class TestNormalizeLivePropertyPayload:
    ...
    def test_returns_shallow_copy(self) -> None:  # noqa: PLR6301, RUF105
    ...
    def test_preserves_all_keys(self) -> None:  # noqa: PLR6301, RUF105
...
class TestSourceRegions:
    ...
    def test_extracts_region_from_price_sources(self) -> None:  # noqa: PLR6301, RUF105
        """Extracts region from price source data."""
        from custom_components.jackery_solarvault.const import FIELD_SYSTEM_REGION  # noqa: I001, PLC0415, RUF105

        source = {FIELD_SYSTEM_REGION: "DE", "other": "data"}
        result = source_regions(source)
        assert "DE" in result

    def test_extracts_region_from_country_field(self) -> None:  # noqa: PLR6301, RUF105
        """Extracts region from country field."""
        from custom_components.jackery_solarvault.const import FIELD_COUNTRY  # noqa: I001, PLC0415, RUF105
    ...
    def test_returns_empty_for_no_region(self) -> None:  # noqa: PLR6301, RUF105
        """Returns empty list when no region key."""
        source = {"price": 0.15}
        result = source_regions(source)
        assert result == []

    def test_returns_empty_for_empty_string(self) -> None:  # noqa: PLR6301, RUF105
    ...
    def test_splits_comma_separated_regions(self) -> None:  # noqa: PLR6301, RUF105
...
class TestFindDictWithAnyKeyAdditional:
    ...
    def test_finds_key_in_nested_list(self) -> None:  # noqa: PLR6301, RUF105
    ...
    def test_returns_none_for_string_input(self) -> None:  # noqa: PLR6301, RUF105
        """Returns None for string input."""
        result = find_dict_with_any_key("string", {"deviceSn"})
        assert result is None

    def test_returns_none_for_int_input(self) -> None:  # noqa: PLR6301, RUF105
...
class TestFindListForKeyAdditional:
    ...
    def test_finds_list_in_deeply_nested_dict(self) -> None:  # noqa: PLR6301, RUF105
