...
class TestBatteryPackFromSource:
    ...
    def test_extracts_from_battery_packs_key(self) -> None:
    ...
    def test_extracts_from_battery_pack_key(self) -> None:
    ...
    def test_extracts_from_battery_pack_list_key(self) -> None:
    ...
    def test_returns_none_when_no_known_keys(self) -> None:
    ...
    def test_extracts_from_sub_device_key(self) -> None:
        """Extracts from FIELD_SUB_DEVICE key."""
        from custom_components.jackery_solarvault.const import FIELD_SUB_DEVICE
    ...
    def test_extracts_from_list_source(self) -> None:
...
class TestMergePresentDictValuesEdgeCases:
    ...
    def test_preserves_base_when_update_is_blank_string(self) -> None:
    ...
    def test_preserves_base_when_update_is_empty_list(self) -> None:
    ...
    def test_preserves_base_when_update_is_empty_dict(self) -> None:
    ...
    def test_blank_update_with_non_blank_base_preserves(self) -> None:
    ...
    def test_update_overwrites_when_base_is_blank(self) -> None:
...
class TestMergeMissingDictValuesEdgeCases:
    ...
    def test_fills_missing_nested_keys(self) -> None:
...
class TestSourceRegions:
    ...
    def test_extracts_region_from_price_sources(self) -> None:
    ...
    def test_extracts_region_from_country_field(self) -> None:
    ...
    def test_returns_empty_for_no_region(self) -> None:
    ...
    def test_splits_comma_separated_regions(self) -> None:
...
class TestFindDictWithAnyKeyAdditional:
    ...
    def test_finds_key_in_nested_list(self) -> None:
...
class TestFindListForKeyAdditional:
    ...
    def test_finds_list_in_deeply_nested_dict(self) -> None:
