...
class TestCoordinatorMainPaths:
    ...
    def _bare_coordinator(self) -> Any:  # ruff: ignore[any-type, no-self-use]  # isort: skip
        ...
        shell._property_source_state = {}  # ruff: ignore[private-member-access]  # isort: skip
        shell._accessory_source_state = {}  # ruff: ignore[private-member-access]  # isort: skip
        shell._property_overrides = {}  # ruff: ignore[private-member-access]  # isort: skip
        shell._background_tasks = {}  # ruff: ignore[private-member-access]  # isort: skip
        shell._configured_update_interval = timedelta(seconds=15)  # ruff: ignore[private-member-access]  # isort: skip
        shell._polling_diagnostics = {}  # ruff: ignore[private-member-access]  # isort: skip
        shell._polling_timeout_started_monotonic = None  # ruff: ignore[private-member-access]  # isort: skip
        shell._mqtt = None  # ruff: ignore[private-member-access]  # isort: skip
        shell._ble_listener = None  # ruff: ignore[private-member-access]  # isort: skip
        shell._device_index = {}  # ruff: ignore[private-member-access]  # isort: skip
    ...
    def test_call_invokes_method(self) -> None:
        ...
        async def run():  # ruff: ignore[missing-return-type-private-function]  # isort: skip
...
class TestBatteryPackFromSource:
    ...
    def test_extracts_from_battery_packs_key(self) -> None:  # ruff: ignore[no-self-use]  # isort: skip
    ...
    def test_extracts_from_battery_pack_key(self) -> None:  # ruff: ignore[no-self-use]  # isort: skip
    ...
    def test_returns_none_when_no_known_keys(self) -> None:  # ruff: ignore[no-self-use]  # isort: skip
    ...
    def test_extracts_from_sub_device_key(self) -> None:  # ruff: ignore[no-self-use]  # isort: skip
        """Extracts from FIELD_SUB_DEVICE key."""
        from custom_components.jackery_solarvault.const import FIELD_SUB_DEVICE  # ruff: ignore[import-outside-top-level]  # isort: skip
    ...
    def test_extracts_from_list_source(self) -> None:  # ruff: ignore[no-self-use]  # isort: skip
...
class TestMergePresentDictValuesEdgeCases:
    ...
    def test_preserves_base_when_update_is_blank_string(self) -> None:  # ruff: ignore[no-self-use]  # isort: skip
    ...
    def test_preserves_base_when_update_is_empty_list(self) -> None:  # ruff: ignore[no-self-use]  # isort: skip
    ...
    def test_preserves_base_when_update_is_empty_dict(self) -> None:  # ruff: ignore[no-self-use]  # isort: skip
    ...
    def test_blank_update_with_non_blank_base_preserves(self) -> None:  # ruff: ignore[no-self-use]  # isort: skip
    ...
    def test_update_overwrites_when_base_is_blank(self) -> None:  # ruff: ignore[no-self-use]  # isort: skip
        """Non-blank update overwrites blank base."""
        base = {"soc": None}
        updates = {"soc": 60}
        result = merge_present_dict_values(base, updates)
        assert result["soc"] == 60  # ruff: ignore[magic-value-comparison]  # isort: skip


class TestMergeMissingDictValuesEdgeCases:
    """Test merge_missing_dict_values edge cases."""

    def test_fills_missing_nested_keys(self) -> None:  # ruff: ignore[no-self-use]  # isort: skip
        ...
        assert result["device"]["voltage"] == 12  # ruff: ignore[magic-value-comparison]  # isort: skip

    def test_does_not_overwrite_existing(self) -> None:  # ruff: ignore[no-self-use]  # isort: skip
...
class TestNormalizeLivePropertyPayload:
    ...
    def test_returns_shallow_copy(self) -> None:  # ruff: ignore[no-self-use]  # isort: skip
    ...
    def test_preserves_all_keys(self) -> None:  # ruff: ignore[no-self-use]  # isort: skip
        """All keys from source are preserved."""
        source = {"soc": 50, "lifetimeEnergy": 1000, "temp": 25}
        result = normalize_live_property_payload(source)
        assert "lifetimeEnergy" in result
        assert result["lifetimeEnergy"] == 1000  # ruff: ignore[magic-value-comparison]  # isort: skip


class TestSourceRegions:
    """Test source_regions helper."""

    def test_extracts_region_from_price_sources(self) -> None:  # ruff: ignore[no-self-use]  # isort: skip
        """Extracts region from price source data."""
        from custom_components.jackery_solarvault.const import FIELD_SYSTEM_REGION  # ruff: ignore[import-outside-top-level]  # isort: skip

        source = {FIELD_SYSTEM_REGION: "DE", "other": "data"}
        result = source_regions(source)
        assert "DE" in result

    def test_extracts_region_from_country_field(self) -> None:  # ruff: ignore[no-self-use]  # isort: skip
        """Extracts region from country field."""
        from custom_components.jackery_solarvault.const import FIELD_COUNTRY  # ruff: ignore[import-outside-top-level]  # isort: skip
    ...
    def test_returns_empty_for_no_region(self) -> None:  # ruff: ignore[no-self-use]  # isort: skip
        """Returns empty list when no region key."""
        source = {"price": 0.15}
        result = source_regions(source)
        assert result == []

    def test_returns_empty_for_empty_string(self) -> None:  # ruff: ignore[no-self-use]  # isort: skip
    ...
    def test_splits_comma_separated_regions(self) -> None:  # ruff: ignore[no-self-use]  # isort: skip
...
class TestFindListForKeyAdditional:
    ...
    def test_finds_list_in_deeply_nested_dict(self) -> None:  # ruff: ignore[no-self-use]  # isort: skip
