...
class TestNormalizeBackfillStatus:
    ...
    def test_known_status_returns_enum(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
        result = _normalize_backfill_status(BackfillStatus.IMPORTED, closed=True)
        assert result == BackfillStatus.IMPORTED

    def test_auth_error_maps_to_retryable(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
        result = _normalize_backfill_status("auth_error", closed=True)
        assert result == BackfillStatus.RETRYABLE

    def test_unknown_open_maps_to_pending(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
        result = _normalize_backfill_status("unknown", closed=False)
        assert result == BackfillStatus.PENDING

    def test_unknown_closed_maps_to_pending(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
        result = _normalize_backfill_status("unknown", closed=True)
        assert result == BackfillStatus.PENDING

    def test_invalid_type_returns_pending(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
...
class TestLoadMqttPushClient:
    ...
    def test_returns_client_class(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
...
class TestSlowFetchFailureLogLevel:
    ...
    def test_returns_log_level(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
...
class TestStablePayloadDebugSignature:
    ...
    def test_returns_signature(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
        event = {"key": "value"}
...
class TestDictListIdentityValues:
    ...
    def test_returns_serial_keys(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
    ...
    def test_returns_id_keys(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
    ...
    def test_skips_blank_values(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
...
class TestMergePresentDictValues:
    ...
    def test_preserves_base_when_update_blank(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
        base = {"key": "value"}
        updates = {"key": None}
        result = merge_present_dict_values(base, updates)
        assert result["key"] == "value"

    def test_update_overwrites_when_base_blank(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
        base = {"key": None}
...
class TestMergeMissingDictValues:
    ...
    def test_fills_missing_nested(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
        base = {"device": {"soc": 50}}
    ...
    def test_does_not_overwrite_existing(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
        base = {"device": {"soc": 50}}
...
class TestMergeDictValues:
    ...
    def test_merges_updates_into_base(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
        base = {"a": 1, "b": 2}
        updates = {"b": 3, "c": 4}
        result = merge_dict_values(base, updates)
        assert result == {"a": 1, "b": 3, "c": 4}

    def test_overwrites_base_with_none(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
        base = {"a": 1}
        updates = {"a": None}
        result = merge_dict_values(base, updates)
        assert result == {"a": None}

    def test_handles_nested_dicts(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
        base = {"device": {"soc": 50}}
        updates = {"device": {"temp": 25}}
        result = merge_dict_values(base, updates)
        assert result["device"]["soc"] == 50  # ruff: ignore[magic-value-comparison]  # isort: skip
...
class TestChangedDictValues:
    ...
    def test_detects_new_keys(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
        before = {"a": 1}
        after = {"a": 1, "b": 2}
        result = changed_dict_values(before, after)
        assert result == {"b": 2}

    def test_detects_changed_values(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
        before = {"a": 1}
        after = {"a": 2}
        result = changed_dict_values(before, after)
        assert result == {"a": 2}
...
class TestNormalizeBatteryPackPayload:
    ...
    def test_flattens_updates_object(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
...
class TestNormalizeLivePropertyPayload:
    ...
    def test_returns_shallow_copy(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
...
class TestNormalizedCompanyId:
    ...
    def test_returns_int_for_valid(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
        result = normalized_company_id("123")
        assert result == 123  # ruff: ignore[magic-value-comparison]  # isort: skip

    def test_returns_none_for_invalid(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
...
class TestNormalizedRegion:
    ...
    def test_uppercases_and_strips(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
...
class TestSourceRegions:
    ...
    def test_extracts_from_system_region(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
        source = {FIELD_SYSTEM_REGION: "DE"}
        result = source_regions(source)
        assert result == ["DE"]

    def test_splits_comma_separated(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
...
class TestNormalizedSourceRegions:
    ...
    def test_normalizes_and_dedupes(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
...
class TestFirstNonblankSourceName:
    ...
    def test_returns_first_nonblank(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
...
class TestIsMqttAuthFailure:
    ...
    def test_recognizes_auth_failure(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
...
class TestIsTransientConnectFailure:
    ...
    def test_recognizes_transient(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
...
class TestMqttConnectFailureSignature:
    ...
    def test_handles_tls_errors(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
...
class TestIsAlarmMessage:
    ...
    def test_returns_false_for_none_message_type(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
        assert is_alarm_message(None, None, {}) is False

    def test_returns_false_for_empty_body(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
...
class TestIsDeviceOtaVersionMessage:
    ...
    def test_returns_false_for_none_action_id(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
...
class TestIsSubdevicePayload:
    ...
    def test_returns_false_for_none_payload(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
        # Function expects dict for payload, test with empty dict
        assert (
            is_subdevice_payload({}, {}, frozenset(), frozenset(), frozenset()) is False
        )

    def test_returns_false_for_empty_payload(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
        assert (
            is_subdevice_payload({}, {}, frozenset(), frozenset(), frozenset()) is False
        )

    def test_returns_true_for_subdevice_message_type(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
...
class TestIsThirdPartyMqttConfigMessage:
    ...
    def test_returns_false_for_none_msg_type(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
...
class TestValidPriceSources:
    ...
    def test_returns_empty_for_invalid(self) -> None:  # ruff: ignore[undocumented-public-method, no-self-use]  # isort: skip
