...
class TestBleBinaryFrame:
    ...
    def test_creation(self) -> None:  # noqa: PLR6301
    ...
    def test_frame_index_property(self) -> None:  # noqa: PLR6301
    ...
    def test_chunk_count_property(self) -> None:  # noqa: PLR6301
    ...
    def test_flags_property(self) -> None:  # noqa: PLR6301
        """Test flags property."""
        frame = BleBinaryFrame(
            frame_index=1,
            chunk_count=1,
    ...
    def test_cmd_property(self) -> None:  # noqa: PLR6301
        """Test cmd property."""
        frame = BleBinaryFrame(
            frame_index=1,
            chunk_count=1,
    ...
    def test_body_property(self) -> None:  # noqa: PLR6301
        """Test body property."""
        frame = BleBinaryFrame(
            frame_index=1,
            chunk_count=1,
    ...
    def test_trailer_property(self) -> None:  # noqa: PLR6301
