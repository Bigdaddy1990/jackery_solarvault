...
class TestBleBinaryFrame:
    ...
    def test_creation(self) -> None:  # ruff: ignore[no-self-use]
    ...
    def test_frame_index_property(self) -> None:  # ruff: ignore[no-self-use]
    ...
    def test_trailer_property(self) -> None:  # ruff: ignore[no-self-use]
