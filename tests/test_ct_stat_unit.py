...
async def test_ct_stat_response_contains_y1_y2_arrays() -> None:
    """CT stat response parsing preserves y1 (primary CT) and y2 (secondary CT) arrays."""
    api = _api()
    payload = {
        "x": ["00:00", "00:05", "00:10"],
...
async def test_ct_stat_wrapper_delegates_with_system_id() -> None:
    """async_get_device_ct_stat delegates to _async_get_device_period_stat with system_id."""
    api = _api()
