...
def _make_api_stub() -> MagicMock:
    ...
    # region_code feeds directly into persisted entry.data; a bare MagicMock
    # auto-attr would leak an unserializable object and fail JSON storage at
    # teardown, so pin it to a real empty string.
    api.region_code = ""
