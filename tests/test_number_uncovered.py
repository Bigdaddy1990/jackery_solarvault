...
class TestMaxFeedGridAllowedValues:
    ...
    def test_under_800_returns_single(self) -> None:
        """Test dynamic max under 800 returns single value."""
        payload = {"properties": {"maxFeedGrid": 600, "maxGridStdPw": 600, "maxOutPw": 600}}
        assert _max_feed_grid_allowed_values(payload) == (800.0,)

    def test_over_800_returns_both(self) -> None:
...
class TestSingleTariffDynamicUnit:
    ...
    def test_single_currency_code(self) -> None:
...
class TestJackeryNumber:
    ...
    def _create_number(self, coordinator, key="soc_charge_limit_set"):
    ...
    def test_native_max_value_dynamic(self) -> None:
        ...
        assert sensor.native_max_value == 2500.0
