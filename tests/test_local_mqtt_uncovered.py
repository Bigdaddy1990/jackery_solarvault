...
class TestJackeryLocalMqttClient:
    ...
    def _create_client(self) -> JackeryLocalMqttClient:
    ...
    def test_local_mqtt_client_retrieval(self) -> None:
        ...
        hass.data = {"jackery_solarvault": {"test_entry": {"local_mqtt_client": client}}}
        result = _local_mqtt_client(hass, entry)
        assert result is client

        # Wrong type
        hass.data = {"jackery_solarvault": {"test_entry": {"local_mqtt_client": "not_a_client"}}}
        result = _local_mqtt_client(hass, entry)
        assert result is None
