...
class TestMqttCredentialCanonical:
    ...
    @pytest.mark.asyncio
    async def test_async_get_mqtt_credentials_is_canonical(self) -> None:  # noqa: PLR6301
    ...
    @pytest.mark.asyncio
    async def test_get_cached_delegates_to_canonical(self) -> None:  # noqa: PLR6301
    ...
    @pytest.mark.asyncio
    async def test_base64_decode_error_raises_typed_error_not_nameerror(self) -> None:  # noqa: PLR6301
    ...
    @pytest.mark.asyncio
    async def test_base64_decode_wrong_length_returns_none(self) -> None:  # noqa: PLR6301
        """Base64 seed of wrong length (not 32 bytes) returns None."""
        api = _make_api()
        api._mqtt_user_id = "user123"
        api._mqtt_seed_b64 = base64.b64encode(b"short").decode(
            "ascii"
    ...
    @pytest.mark.asyncio
    async def test_no_plaintext_token_in_logs(self) -> None:  # noqa: PLR6301
    ...
    @pytest.mark.asyncio
    async def test_no_direct_decoding_duplication_in_rsa_encrypt(self) -> None:  # noqa: PLR6301
    ...
    @pytest.mark.asyncio
    async def test_mqtt_credential_structure_is_complete(self) -> None:  # noqa: PLR6301
