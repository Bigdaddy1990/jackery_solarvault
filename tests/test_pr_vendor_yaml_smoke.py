...
class TestDumpAll:
    ...
    def test_dump_all_returns_str_when_no_stream_no_encoding(self) -> None:
        """dump_all must return a str when stream is None and encoding is None."""
        result = yaml.dump_all([{"a": 1}])
        assert isinstance(result, str)
        assert "a: 1" in result

    def test_dump_all_returns_bytes_when_encoding_set(self) -> None:
    ...
    def test_dump_all_empty_documents_list(self) -> None:
...
class TestDump:
    ...
    def test_dump_returns_str_when_no_stream(self) -> None:
...
class TestSafeDump:
    ...
    def test_safe_dump_list(self) -> None:
    ...
    def test_safe_dump_empty_dict(self) -> None:
        """safe_dump must serialize an empty dict as '{}'."""
        result = yaml.safe_dump({})
        assert "{}" in result or result.strip() == "{}"

    def test_safe_dump_all_returns_str_when_no_stream(self) -> None:
...
class TestAddConstructor:
    ...
    def test_add_constructor_registered_and_invoked(self) -> None:
    ...
    def test_add_constructor_none_loader_does_not_raise(self) -> None:
...
class TestAddRepresenter:
    """Smoke tests for add_representer and add_multi_representer (docstrings reformatted)."""

    def test_add_representer_used_for_custom_type(self) -> None:
    ...
    def test_add_multi_representer_used_for_subclasses(self) -> None:
...
class TestYAMLObject:
    ...
    def test_yaml_object_round_trip(self) -> None:
    ...
    def test_yaml_object_from_yaml_returns_instance(self) -> None:
    ...
    def test_yaml_object_to_yaml_produces_tag(self) -> None:
...
class TestSafeConstructorFloat:
    ...
    def test_sexagesimal_float_via_safe_load(self) -> None:
...
class TestSafeConstructorOmap:
    ...
    def test_omap_preserves_order(self) -> None:
...
class TestSafeConstructorPairs:
    ...
    def test_pairs_returns_list_of_tuples(self) -> None:
...
class TestSafeConstructorSet:
    ...
    def test_set_returns_python_set(self) -> None:
...
class TestSafeConstructorTimestamp:
    ...
    def test_date_only_scalar_returns_date(self) -> None:
    ...
    def test_datetime_scalar_returns_datetime(self) -> None:
    ...
    def test_datetime_with_offset_returns_datetime_with_tzinfo(self) -> None:
...
class TestSafeConstructorBinary:
    ...
    def test_binary_scalar_round_trips(self) -> None:
...
class TestDumpAllEdgeCases:
    ...
    def test_dump_all_nested_structure(self) -> None:
    ...
    def test_dump_all_with_unicode_key(self) -> None:
        """dump_all must handle unicode keys without errors."""
        result = yaml.dump_all([{"Ключ": "значение"}], allow_unicode=True)
        assert isinstance(result, str)

    def test_dump_roundtrip_preserves_data(self) -> None:
        """Data serialized by dump and loaded by safe_load must be equal to the original."""
...
class TestLoadBoundaryConditions:
    """Boundary and regression tests for the load path (docstrings reformatted in composer/constructor)."""

    def test_load_empty_document_returns_none(self) -> None:
        """Loading an empty YAML string must return None."""
        result = yaml.safe_load("")
        assert result is None

    def test_load_null_returns_none(self) -> None:
        """Loading 'null' must return Python None."""
        result = yaml.safe_load("null")
        assert result is None

    def test_load_mapping_with_anchor_and_alias(self) -> None:
