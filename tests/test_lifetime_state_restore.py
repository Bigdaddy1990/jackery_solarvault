...
def test_system_lifetime_restore_is_replaced_by_real_transport_value() -> None:
    ...
    sensor._restored_lifetime_value = 54.25  # ruff: ignore[private-member-access]
...
def test_pack_lifetime_restore_is_replaced_by_real_transport_value() -> None:
    ...
    mutable._restored_lifetime_value = 26.523  # ruff: ignore[private-member-access]
...
def test_smart_plug_lifetime_restore_is_replaced_by_real_transport_value() -> None:
    ...
    mutable._cached_native_value = None  # ruff: ignore[private-member-access]
    mutable._cached_attrs = {}  # ruff: ignore[private-member-access]
    mutable._restored_lifetime_value = 12.5  # ruff: ignore[private-member-access]
