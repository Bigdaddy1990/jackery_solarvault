...
def test_jackery_corrected_home_consumption_requires_ct_for_fallback_formula() -> None:
    """Implement test jackery corrected home consumption requires ct for fallback formula."""  # noqa: E501, RUF105
    assert (
...
def test_period_trend_totals_use_same_chart_series_logic_for_week_month_year() -> None:
    """Implement test period trend totals use same chart series logic for week month year."""  # noqa: E501, RUF105
...
def test_period_trend_entities_can_be_created_from_series_without_server_total() -> (
    ...
    """Implement test period trend entities can be created from series without server total."""  # noqa: E501, RUF105
...
def test_config_entry_bool_option_parses_legacy_string_values() -> None:
    ...
    class Entry:
        options = {"enabled": "false"}  # noqa: RUF012, RUF105
        data = {"enabled": True, "fallback": "yes"}  # noqa: RUF012, RUF105
