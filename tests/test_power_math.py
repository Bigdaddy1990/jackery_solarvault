...
def test_year_month_backfill_reconstructs_cloud_month_only_year_payload() -> None:
    ...
    assert payload["statistic"]["totalRevenue"] == 46.72  # Bug B2 fixed: calculated publishes
...
def test_total_savings_uses_house_side_energy_not_pv_revenue() -> None:
    ...
    assert payload["statistic"]["totalRevenue"] == 46.75  # Bug B2 fixed: calculated publishes
...
def test_total_savings_subtracts_ct_export_when_available() -> None:
    ...
    assert payload["statistic"]["totalRevenue"] == 44.8  # Bug B2 fixed: calculated publishes
