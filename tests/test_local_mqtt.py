"""Unit tests for custom_components.jackery_solarvault.client.mqtt.local_mqtt.
...
from custom_components.jackery_solarvault.client.mqtt import local_mqtt as module
...
def test_handle_message_drops_invalid_json_text() -> None:
    ...
    client = _make_client()
    client._handle_message("topic", b"not json at all")  # noqa: SLF001
...
def test_handle_message_without_sink_skips_json_parse() -> None:
    ...
    with patch(
        "custom_components.jackery_solarvault.client.mqtt.local_mqtt.json.loads",
