...
class TestBackfillOpenPeriodState:
    ...
    def test_backfill_status_enum_has_correct_states(self) -> None:  # noqa: PLR6301
    ...
    def test_current_day_is_never_closed(self) -> None:  # noqa: PLR6301
    ...
    def test_current_week_is_never_closed(self) -> None:  # noqa: PLR6301
    ...
    def test_current_month_is_never_closed(self) -> None:  # noqa: PLR6301
    ...
    def test_current_year_is_never_closed(self) -> None:  # noqa: PLR6301
    ...
    def test_two_empty_responses_do_not_make_open_period_terminal(self) -> None:  # noqa: PLR6301
    ...
    def test_current_month_present_in_current_year_reconstruction(self) -> None:  # noqa: PLR6301
        """Current month must be included when reconstructing current year backfill."""
        today = date(2026, 7, 15)
        year_start = date(2026, 1, 1)

        months = JackerySolarVaultCoordinator._iter_calendar_months(year_start, today)
    ...
    def test_closed_periods_retry_bounded_times_before_unavailable(self) -> None:  # noqa: PLR6301
    ...
    def test_legacy_statuses_map_to_state_machine(self) -> None:  # noqa: PLR6301
    ...
    def test_no_active_period_becomes_unavailable_closed(self) -> None:  # noqa: PLR6301
    ...
    def test_backfill_status_serializable(self) -> None:  # noqa: PLR6301
    ...
    def test_migrate_legacy_cache_deterministically(self) -> None:  # noqa: PLR6301
...
class TestBackfillPeriodClosure:
    ...
    def test_day_boundary(self) -> None:  # noqa: PLR6301
    ...
    def test_week_boundary(self) -> None:  # noqa: PLR6301
    ...
    def test_month_boundary(self) -> None:  # noqa: PLR6301
    ...
    def test_year_boundary(self) -> None:  # noqa: PLR6301
