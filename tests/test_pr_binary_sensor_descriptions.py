...
class TestBinaryDescriptionsStructure:
    ...
    def test_count_is_three(self) -> None:  # noqa: PLR6301
        """BINARY_DESCRIPTIONS must have exactly 3 entries (online, eps_active, eth_connected)."""  # noqa: E501
    ...
    def test_all_entries_have_translation_key(self) -> None:  # noqa: PLR6301
        ...
        for desc in BINARY_DESCRIPTIONS:
            assert desc.translation_key, (
                f"Description '{desc.key}' has invalid translation_key: {desc.translation_key!r}"  # noqa: E501
            )
    ...
    def test_all_entries_have_diagnostic_category(self) -> None:  # noqa: PLR6301
        ...
        for desc in BINARY_DESCRIPTIONS:
            assert desc.entity_category == EntityCategory.DIAGNOSTIC, (
                f"Description '{desc.key}' has entity_category={desc.entity_category!r}, expected DIAGNOSTIC"  # noqa: E501
            )
...
class TestJackeryBinarySensorEntityFlags:
    ...
    def test_diagnostic_sensor_is_disabled_by_default(self) -> None:  # noqa: PLR6301
        """All DIAGNOSTIC binary sensors must be disabled in the entity registry by default."""  # noqa: E501
        for desc in BINARY_DESCRIPTIONS:
    ...
    def test_unique_id_is_device_id_and_key(self) -> None:  # noqa: PLR6301
        ...
        for desc in BINARY_DESCRIPTIONS:
            ...
            assert sensor._attr_unique_id == f"device_123_{desc.key}", (  # noqa: SLF001
                f"Sensor '{desc.key}' has unexpected unique_id: {sensor._attr_unique_id!r}"  # noqa: E501, SLF001
            )

    def test_entity_description_is_set(self) -> None:  # noqa: PLR6301
        """The entity_description attribute must be the same object passed to __init__."""  # noqa: E501
        for desc in BINARY_DESCRIPTIONS:
            sensor = _make_sensor(desc)
...
class TestJackeryBinarySensorIsOn:
    ...
    def test_online_is_on_when_online_status_truthy(self) -> None:  # noqa: PLR6301
    ...
    def test_online_reads_from_device_meta_not_properties(self) -> None:  # noqa: PLR6301
        """'online' getter reads FIELD_ONLINE_STATUS from device_meta, ignoring properties."""  # noqa: E501
        desc = next(d for d in BINARY_DESCRIPTIONS if d.key == "online")
    ...
    def test_eps_active_is_on_when_eps_state_truthy(self) -> None:  # noqa: PLR6301
    ...
    def test_eps_active_reads_from_properties_not_device_meta(self) -> None:  # noqa: PLR6301
        """'eps_active' getter reads FIELD_SW_EPS_STATE from properties, not device_meta."""  # noqa: E501
        desc = next(d for d in BINARY_DESCRIPTIONS if d.key == "eps_active")
        sensor = _make_sensor(
            desc,
            properties={},
    ...
    def test_eth_connected_is_on_when_eth_port_truthy(self) -> None:  # noqa: PLR6301
    ...
    def test_is_on_returns_true_for_integer_one(self) -> None:  # noqa: PLR6301
...
class TestJackeryBinarySensorNoPayload:
    ...
    def test_is_on_returns_none_when_coordinator_data_is_none(self) -> None:  # noqa: PLR6301
    ...
    def test_is_on_returns_none_when_properties_section_missing(self) -> None:  # noqa: PLR6301
        """is_on must return None when PAYLOAD_PROPERTIES is absent from device payload."""  # noqa: E501
        coordinator = MagicMock()
...
class TestGetterIsolation:
    ...
    def test_online_getter_reads_only_device_meta(self) -> None:  # noqa: PLR6301
        """'online' getter must use the second argument (device_meta), not properties."""  # noqa: E501
        desc = next(d for d in BINARY_DESCRIPTIONS if d.key == "online")
    ...
    def test_eps_active_getter_reads_only_properties(self) -> None:  # noqa: PLR6301
        """'eps_active' getter must use the first argument (properties), not device_meta."""  # noqa: E501
        desc = next(d for d in BINARY_DESCRIPTIONS if d.key == "eps_active")
