...
from ...handlers.detector import subdevice_identity_values  # noqa: RUF100, TID252
from ...handlers.property_merge import (  # noqa: RUF100, TID252
    merge_dict_values,
...
def merge_battery_pack_lists(
    ...
    (FIELD_DEVICE_SN / FIELD_DEV_SN / FIELD_SN) and falling back to list position when
    no SN match exists. Non-dict and None entries from the prior list are ignored. The
    function updates a pack's PACK_FIELD_LAST_SEEN_AT timestamp only when its commState
    transitions to "1".
...
def merge_circuits(
    ...
    from ...util import circuit_id  # noqa: PLC0415, RUF100, TID252
...
def merge_sub_devices(
    ...
    from ...util import sub_device_serial  # noqa: PLC0415, RUF100, TID252
