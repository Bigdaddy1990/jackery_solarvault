...
# No implicit fallback. The documented local Jackery bridge topic name is not
# stable across all setups, and "homeassistant" commonly captures HA's own
# event stream instead of device telemetry.
