...
# is still open.
MQTT_SILENT_THRESHOLD_SEC: Final = 90
...
DEFAULT_BLE_ACK_TIMEOUT_SEC: Final = 20
...
ADAPTIVE_KEEPALIVE_INTERVAL_SEC: Final = 15
...
DEFAULT_THIRD_PARTY_MQTT_IP: Final = "192.168.2.1"  # example and for test
...
DEFAULT_THIRD_PARTY_MQTT_USERNAME: Final = "mqtt_user"  # example and for test
CONF_THIRD_PARTY_MQTT_PASSWORD: Final = "third_party_mqtt_password"
DEFAULT_THIRD_PARTY_MQTT_PASSWORD: Final = "12345678"  # example and for test
CONF_THIRD_PARTY_MQTT_TOKEN: Final = "third_party_mqtt_token"
DEFAULT_THIRD_PARTY_MQTT_TOKEN: Final =  ""  # Generated by App, BLE Key and hardcorded string
...
DEVICE_PORTABLE_CT_STAT_PATH: Final =  "/v1/device/stat/ct/statics"  # ?deviceId=<portable device>
...
DEVICE_SOCKET_STATISTIC_PATH: Final =  "/v1/device/stat/smartSocketStatistic"  # ?smartSocketId=<socket accessory>
...
DEFAULT_CREATE_CALCULATED_POWER_SENSORS: Final = True
DEFAULT_CREATE_SAVINGS_DETAIL_SENSORS: Final = True
...
HTTP_RAW_TEXT_LIMIT: Final = 2000
...
# --- PortableBody fields (Explorer power stations) ---
...
ACTION_ID_CONTROL_SOCKET_SWITCH: Final = 3024  # cmd=111 ControlSubDevice (Smart-Plug sysSwitch on/off)
ACTION_ID_CONTROL_SOCKET_PRIORITY: Final = 3025  # cmd=111 ControlSubDevice (socketPri toggle)
...
ACTION_ID_SUBDEVICE_3032: Final = 3032  # cmd=110 QuerySubDeviceGroupProperty, smart plug / socket
ACTION_ID_SUBDEVICE_3033: Final = 3033  # cmd=110 QuerySubDeviceGroupProperty, meter head
...
ACTION_ID_QUERY_THIRD_PARTY_MQTT_CONFIG: Final = 3047  # cmd=114 QueryThirdPartMQTTConfig
