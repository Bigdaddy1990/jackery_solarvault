...
# toggle was removed; we neeed to implement the ble buttons on this! #TODO
...
# cmd=107 DevicePropertyChange (socChgLimit + socDischgLimit combined)
ACTION_ID_SOC_CHARGE_LIMIT: Final = 3028
