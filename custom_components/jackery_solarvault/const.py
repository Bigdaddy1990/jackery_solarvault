...
# system/list discovery endpoint
SYSTEM_LIST_PATH: Final = "/v1/device/system/list"
...
# ?systemId&...
BATTERY_TRENDS_PATH: Final = "/v1/device/stat/sys/battery/trends"
...
# Pack lifetime charged energy in Wh (BLE cmd=120)
FIELD_IN_EGY: Final = "inEgy"
FIELD_IN_PW: Final = "inPw"
# Pack lifetime discharged energy in Wh (BLE cmd=120)
FIELD_OUT_EGY: Final = "outEgy"
...
# cmd=107 DevicePropertyChange (chg + dischg)
ACTION_ID_SOC_LIMITS: Final = 3028
...
# authoritative.
# cmd=107 DevicePropertyChange (EPS toggle)
ACTION_ID_EPS_ENABLED: Final = 3022
# cmd=107 DevicePropertyChange (standby mode 1/2)
ACTION_ID_STANDBY: Final = 3023
