...
| `device_pv1_day_energy` | `device_pv_stat_day` | `pv1Egy` | `/v1/device/stat/pv` | `y1` |
...
| `device_pv2_day_energy` | `device_pv_stat_day` | `pv2Egy` | `/v1/device/stat/pv` | `y2` |
...
| `device_pv3_day_energy` | `device_pv_stat_day` | `pv3Egy` | `/v1/device/stat/pv` | `y3` |
...
| `device_pv4_day_energy` | `device_pv_stat_day` | `pv4Egy` | `/v1/device/stat/pv` | `y4` |
