...
- Monat = Kalendermonat.
- Jahr = Kalenderjahr.
- Gesamtwerte/Lifetime-Werte kommen aus den dokumentierten App-/HTTP-/MQTT-Gesamtfeldern und werden nicht aus Wochen-, Monats- oder Jahreswerten zusammengesetzt.
- Es gibt ausdrücklich keine Wochenwerte zur Reparatur von Monats-, Jahres- oder Gesamtwerten und keine Monatswerte zur Reparatur von Jahres- oder Gesamtwerten.
...
- Python 3.13+ (wird über Home Assistant bereitgestellt)
