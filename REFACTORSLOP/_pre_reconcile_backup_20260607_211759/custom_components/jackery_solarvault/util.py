...
from collections.abc import Callable  # noqa: I001, TC003
...
# --- restored from Clause/live lineage (backup) ---
_LOGGER = logging.getLogger(__name__)
ZERO_CONFIRM_MIN_LOCAL_HOUR: Final = 20


def config_entry_bool_option(entry: object, key: str, default: bool) -> bool:  # noqa: E302, RUF100
...
def sorted_smart_plugs(plugs: object) -> list[dict[str, Any]]:
    ...
    entries.sort(key=lambda item: item[0])  # noqa: FURB118
...
class AppDataQualityWarning(NamedTuple):
    ...
    # --- restored from 24.05\24.05\custom_components\jackery_solarvault\util.py ---  # noqa: E303, RUF100
    def _stat_source_shape(source: Any) -> tuple[tuple[str, str], ...]:  # noqa: N805
...
def _compact_year_parts(value: object) -> tuple[float, float] | None:
    ...
    unsigned = text[1:] if text.startswith("-") else text  # noqa: FURB188
    if "." not in unsigned:
...
def trend_series_points(  # noqa: PLR0912
    ...
    *,
    ...
    if not isinstance(series, list) or not series:
        return []
    series_values = cast(list[Any], series)  # noqa: TC006
...
def first_nonblank(*values: Any) -> str | None:  # noqa: E302, RUF100
...
def first_nonblank_int(*values: Any) -> int | None:  # noqa: E302, PLR0911, RUF100
...
def _is_signed_battery_energy_curve(section: str, stat_key: str) -> bool:  # noqa: E302, RUF100
...
def _can_distribute_scalar_day_total(section: str, stat_key: str) -> bool:  # noqa: E302, RUF100
...
def entry_bool_option(entry: Any, key: str, default: bool) -> bool:  # noqa: ANN401, E302, RUF100
