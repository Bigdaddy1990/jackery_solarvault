...
from datetime import UTC, date, datetime, timedelta, tzinfo  # noqa: TC003
import logging
...
from homeassistant.core import HomeAssistant, callback  # noqa: TC001
from homeassistant.helpers.device_registry import DeviceInfo
from homeassistant.helpers.entity_platform import AddEntitiesCallback  # noqa: TC001
from homeassistant.util import dt as dt_util

from . import JackeryConfigEntry  # noqa: TC001
from .const import (
...
from .util import (
    HomeConsumptionPower,  # noqa: TC001
...
def _path(props: dict[str, Any], *keys: str) -> Any:  # noqa: ANN401, E302, RUF100
        ...
        for dev_id, payload in (coordinator.data or {}).items():
            ...
            if isinstance(packs, list):
                ...
                if bat_num is None:
                    ...
                    pack_count = min(5, max(len(valid_packs), max(0, bat_num)))  # noqa: PLW3301
...
class JackeryStatSensor(JackeryEntity, SensorEntity):
    ...
    # --- restored from 24.05\24.05\custom_components\jackery_solarvault\sensor.py ---  # noqa: E303, RUF100
...
class JackeryBatteryPackSensor(JackeryEntity, SensorEntity):  # noqa: E302, RUF100
