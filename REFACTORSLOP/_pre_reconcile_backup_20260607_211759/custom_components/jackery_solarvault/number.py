...
from collections.abc import Awaitable, Callable  # noqa: I001, TC003
...
def _rounded_int(value: Any) -> int:  # noqa: ANN401
    ...
    return int(round(parsed))  # noqa: RUF046
...
async def _set_third_party_mqtt_port(  # noqa: E302, RUF100
    coord: JackerySolarVaultCoordinator, dev_id: str, value: float
) -> None:
