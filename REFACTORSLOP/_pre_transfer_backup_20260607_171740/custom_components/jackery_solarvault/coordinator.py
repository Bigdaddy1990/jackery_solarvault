...
class JackerySolarVaultCoordinator(DataUpdateCoordinator[dict[str, dict[str, Any]]]):  # noqa: PLR0904
    ...
    async def async_start_ble_transport(self) -> None:  # noqa: PLR0915
        ...
        try:
            from .client.ble_transport import (
                JackeryBleListener,  # noqa: PLC0415, RUF100
            )
        ...
        if dev_mode_redactions_disabled():
            import base64 as _base64  # noqa: PLC0415, RUF100
    ...
    def device_bluetooth_key(self, device_id: str) -> bytes | None:
        ...
        """
        from .client.ble import BLE_AES_KEY_LENGTHS  # noqa: PLC0415, RUF100
    ...
    async def async_cleanup_pending_device_removals(self) -> int:
        ...
        from homeassistant.helpers import device_registry as dr  # noqa: PLC0415, RUF100
    ...
    async def _async_statistic_sum_offset(
        ...
        try:
            from homeassistant.components.recorder import (
                get_instance,  # noqa: PLC0415, RUF100
            )
    ...
    async def _async_entity_statistic_offsets(
        ...
        try:
            ...
            from homeassistant.components.recorder.db_schema import (  # noqa: PLC0415, RUF100
                Statistics,
                StatisticsMeta,
            )
    ...
    async def _async_import_app_chart_entity_statistics_for_device(  # noqa: PLR0912, PLR0914, PLR0915
        ...
        *,
        ...
        if not entity_ids:
            return 0, 0
        try:
            from homeassistant.components.recorder.models import (  # noqa: I001, PLC0415, RUF100
                StatisticMeanType,
                StatisticMetaData,
            )
            from homeassistant.components.recorder.statistics import (  # noqa: PLC0415, RUF100
