...
from collections.abc import Awaitable, Callable  # noqa: F401, TC003
import contextlib
...
from ..const import (
    ...
    _HOME_ASSISTANT_EVENT_HEAD_BYTES,
    _LOCAL_MQTT_JACKERY_MARKER_KEYS,
    LocalMqttSink,  # noqa: TC001
)
...
class JackeryLocalMqttClient:
    ...
    async def _async_run_session(self) -> None:
        ...
        """  # noqa: E501, RUF100
        try:
            from aiomqtt import Client, MqttError  # noqa: PLC0415, RUF100
