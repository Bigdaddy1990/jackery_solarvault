...
CRITICAL_MODULES: dict[str, int] = {
    ...
    "custom_components/jackery_solarvault/coordinator.py": 65,  # Complex async integration; 90% impractical with unit tests
    "custom_components/jackery_solarvault/services.py": 90,
    "custom_components/jackery_solarvault/ingest.py": 90,
}
...
def enforce(
    *,
    ...
    print(
        ...
        f"critical_modules met per-module thresholds"
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--total-minimum-percent", default="65")
