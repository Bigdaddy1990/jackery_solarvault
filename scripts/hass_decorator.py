...
class HassDecoratorChecker(BaseChecker):
    ...
    def _get_pytest_fixture_node(self, node: nodes.FunctionDef) -> nodes.Call | None:  # noqa: PLR6301
    ...
    def _get_pytest_fixture_node_keyword(  # noqa: PLR6301
    ...
    def _check_pytest_fixture(
        ...
        if (
            "_pytest.fixtures.FixtureFunctionMarker" not in decoratornames  # noqa: PLR0916
        ...
        test_module = parts[3] if len(parts) > 3 else ""  # noqa: PLR2004
