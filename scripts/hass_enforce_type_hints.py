...
def _is_valid_type(  # noqa: PLR0911, PLR0912
    ...
    assert isinstance(expected_type, str)  # noqa: S101
    ...
    if (
        ...
        if (
            len(node.slice.elts) == 2  # noqa: PLR2004
            and in_return
...
def _is_valid_return_type(match: TypeHintMatch, node: nodes.NodeNG) -> bool:  # noqa: PLR0912
