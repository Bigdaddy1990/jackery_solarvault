...
class Emitter:  # noqa: D101, PLR0904
    ...
    def __init__(  # noqa: D107, PLR0913, PLR0917
        ...
        """
        Initialize the Emitter with output stream and formatting options and set up its internal state machine.
    ...
    def emit(self, event) -> None:  # noqa: ANN001, D102
        """
    ...
    def need_more_events(self):  # noqa: ANN201, D102
        """
    ...
    def need_events(self, count):  # noqa: ANN001, ANN201, D102
        """
    ...
    def increase_indent(self, flow=False, indentless=False) -> None:  # noqa: ANN001, D102
        """
    ...
    def expect_stream_start(self) -> None:  # noqa: D102
        """
    ...
    def expect_nothing(self) -> Never:  # noqa: D102
        """
    ...
    def expect_first_document_start(self):  # noqa: ANN201, D102
        """
    ...
    def expect_document_start(self, first=False) -> None:  # noqa: ANN001, D102
        """
    ...
    def expect_document_end(self) -> None:  # noqa: D102
        """
    ...
    def expect_document_root(self) -> None:  # noqa: D102
        """
    ...
    def expect_alias(self) -> None:  # noqa: D102
        """
    ...
    def expect_scalar(self) -> None:  # noqa: D102
        """
    ...
    def expect_flow_sequence(self) -> None:  # noqa: D102
        """
    ...
    def expect_first_flow_sequence_item(self) -> None:  # noqa: D102
        """
    ...
    def expect_flow_sequence_item(self) -> None:  # noqa: D102
        """
    ...
    def expect_flow_mapping(self) -> None:  # noqa: D102
        """
    ...
    def expect_first_flow_mapping_key(self) -> None:  # noqa: D102
        """
    ...
    def expect_flow_mapping_key(self) -> None:  # noqa: D102
        """
    ...
    def expect_flow_mapping_simple_value(self) -> None:  # noqa: D102
        """
    ...
    def expect_flow_mapping_value(self) -> None:  # noqa: D102
        """
    ...
    def expect_block_sequence(self) -> None:  # noqa: D102
        """
    ...
    def expect_first_block_sequence_item(self):  # noqa: ANN201, D102
        """
        Delegate to expect_block_sequence_item with `first=True` to handle the first item of a block sequence.
        """
        return self.expect_block_sequence_item(first=True)

    def expect_block_sequence_item(self, first=False) -> None:  # noqa: ANN001, D102
        """
    ...
    def expect_block_mapping(self) -> None:  # noqa: D102
        """
    ...
    def expect_first_block_mapping_key(self):  # noqa: ANN201, D102
        """
    ...
    def expect_block_mapping_key(self, first=False) -> None:  # noqa: ANN001, D102
        """
    ...
    def expect_block_mapping_simple_value(self) -> None:  # noqa: D102
        """
    ...
    def expect_block_mapping_value(self) -> None:  # noqa: D102
        """
    ...
    def check_empty_sequence(self):  # noqa: ANN201, D102
        """
    ...
    def check_empty_mapping(self):  # noqa: ANN201, D102
        """
    ...
    def check_empty_document(self):  # noqa: ANN201, D102
        """
    ...
    def check_simple_key(self):  # noqa: ANN201, D102
        """
    ...
    def process_anchor(self, indicator) -> None:  # noqa: ANN001, D102
        """
    ...
    def process_tag(self) -> None:  # noqa: D102
        """
    ...
    def choose_scalar_style(self):  # noqa: ANN201, D102
        """
    ...
    def process_scalar(self) -> None:  # noqa: D102
        """
    ...
    def prepare_version(self, version) -> str:  # noqa: ANN001, D102, PLR6301
        """
    ...
    def prepare_tag_handle(self, handle):  # noqa: ANN001, ANN201, D102, PLR6301
        """
    ...
    def prepare_tag_prefix(self, prefix):  # noqa: ANN001, ANN201, D102, PLR6301
        """
        ...
        while end < len(prefix):
            ...
            if (
                ...
                chunks.extend(f"%{ord(ch):02X}" for ch in data)
        if start < end:
            chunks.append(prefix[start:end])
        return "".join(chunks)

    def prepare_tag(self, tag):  # noqa: ANN001, ANN201, D102
        """
        ...
        while end < len(suffix):
            ...
            if (
                ...
                start = end = end + 1
                data = ch.encode("utf-8")
                chunks.extend(f"%{ch:02X}" for ch in data)
        if start < end:
            chunks.append(suffix[start:end])
    ...
    def prepare_anchor(self, anchor):  # noqa: ANN001, ANN201, D102, PLR6301
        """
    ...
    def flush_stream(self) -> None:  # noqa: D102
        """
    ...
    def write_stream_start(self) -> None:  # noqa: D102
        # Write BOM if needed.
        """
    ...
    def write_indent(self) -> None:  # noqa: D102
        """
    ...
    def write_line_break(self, data=None) -> None:  # noqa: ANN001, D102
        """
    ...
    def write_version_directive(self, version_text) -> None:  # noqa: ANN001, D102
        """
    ...
    def write_tag_directive(self, handle_text, prefix_text) -> None:  # noqa: ANN001, D102
        """
    ...
    def write_single_quoted(self, text, split=True) -> None:  # noqa: ANN001, D102, PLR0912
        """
    ...
    def write_double_quoted(self, text, split=True) -> None:  # noqa: ANN001, D102, PLR0912
        """
        Serialize `text` as a double-quoted YAML scalar and write it (including surrounding double quotes) to the emitter's output stream.
    ...
    def determine_block_hints(self, text):  # noqa: ANN001, ANN201, D102
        """
    ...
    def write_folded(self, text) -> None:  # noqa: ANN001, D102, PLR0912
        """
    ...
    def write_literal(self, text) -> None:  # noqa: ANN001, D102, PLR0912
        """
    ...
    def write_plain(self, text, split=True) -> None:  # noqa: ANN001, D102, PLR0912, PLR0915
        """
